...
<html>
  ...
  <ul class="nav nav-sidebar">
            ...
            <li><a href="C_Home.php?page=fsp">Payment Summary</a></li>
            <li><a href="C_Home.php?page=gsp">Order Details</a></li>
    ...
    <center>
      <div class="container">
        <form name="form" action="" method="_POST">
          <button class="button button3" formaction="cod.php">PROCEED TO PAYMENT<img src="payment.png" width="300" height="150"></button>
        </form>
      </div>
