  ...
  <nav class="navbar navbar-default navbar-fixed-top" style="background:#000">
    <div class="container">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="C_Registration.php"><span class="glyphicon glyphicon-user"></span> Register</a></li>
        <li class="active"><a href="C_Login.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
      </ul>
    ...
    <div class="box">
      ...
      <table>
        ...
        <tr>
          ...
          <td><input type="text" name="custEmail" required><br><br></td>
        </tr>

        <tr>
          <td>Password<br><br></td>
          <td><input type="password" name="custPassword" required minlength="8" maxlength="15"><br><br></td>
        </tr>
